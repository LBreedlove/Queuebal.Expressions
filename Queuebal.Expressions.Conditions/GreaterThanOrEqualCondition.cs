...
/// <summary>
/// A condition that checks if the input value is greater or equal to the comparer value.
/// </summary>
public class GreaterThanOrEqualCondition : BinaryCondition
{
    /// <summary>
    /// Gets the name of the condition type.
    /// </summary>
    public static string ConditionType { get; } = "GreaterThanOrEqual";

    /// <summary>
    /// Evaluates the condition by checking if the input value is greater than or equal to the specified value.
    /// </summary>
    /// <param name="context">The context the condition is running in.</param>
    /// <param name="inputValue">The value to compare against.</param>
    /// <returns>true if the input value is greater than or equal to the specified value, otherwise false.</returns>
    protected override bool EvaluateCondition(ExpressionContext context, JSONValue inputValue, JSONValue comparerValue)
    {
        ...
        {
            throw new InvalidOperationException("GreaterThanOrEqual can only compare values of the same type");
        }
