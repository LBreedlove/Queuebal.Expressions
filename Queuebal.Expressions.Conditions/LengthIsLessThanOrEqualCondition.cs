...
/// <summary>
/// A condition that checks if the input value's length is less than or equal to the comparer value,
/// or the length of the comparer value.
/// </summary>
public class LengthIsLessThanOrEqualCondition : BinaryCondition
{
    ...
    /// </summary>
    public static string ConditionType { get; } = "LengthIsLessThanOrEqual";
    ...
    /// <returns>true if the input value's length is less than or equal to the specified value, otherwise false.</returns>
