...
public class TestGreaterThanCondition
{
    ...
    public void test_evaluate_when_input_value_is_greater_than_comparer()
    {
        ...
        // Act
        var result = new GreaterThanCondition { ComparerValue = comparerValue }.Evaluate(Context, inputValue);
    ...
    public void test_evaluate_when_input_value_is_not_a_number_or_string()
    {
        ...
        // Act & Assert
        Assert.Throws<InvalidOperationException>(() => new GreaterThanCondition { ComparerValue = comparerValue }.Evaluate(Context, inputValue));
    }

    [TestMethod]
    public void test_evaluate_when_comparer_type_does_not_match_string_input_value_type()
    {
        // Arrange
