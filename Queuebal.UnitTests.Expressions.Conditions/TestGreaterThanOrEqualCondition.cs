...
[TestClass]
public class TestGreaterThanOrEqualCondition
{
    ...
    public void test_evaluate_when_input_value_is_greater_than_comparer()
    {
        ...
        // Act
        var result = new GreaterThanOrEqualCondition { ComparerValue = comparerValue }.Evaluate(Context, inputValue);
    ...
    public void test_evaluate_when_input_value_is_not_a_number_or_string()
    {
        ...
        // Act & Assert
        Assert.Throws<InvalidOperationException>(() => new GreaterThanOrEqualCondition { ComparerValue = comparerValue }.Evaluate(Context, inputValue));
    }
