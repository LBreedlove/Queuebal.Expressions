...
[TestClass]
public class TestLengthIsGreaterThanCondition
{
    ...
    public void test_evaluate_when_input_is_null_returns_false()
    {
        ...
        // Act
        var result = new LengthIsGreaterThanCondition { ComparerValue = comparer }.Evaluate(Context, inputValue);
    ...
    public void test_evaluate_when_input_is_invalid_type_throws()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<InvalidOperationException>(() => new LengthIsGreaterThanCondition { ComparerValue = comparer }.Evaluate(Context, inputValue));
    }
