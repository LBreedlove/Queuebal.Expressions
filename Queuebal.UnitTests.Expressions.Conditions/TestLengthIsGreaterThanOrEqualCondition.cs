...
[TestClass]
public class TestLengthIsGreaterThanOrEqualCondition
{
    ...
    public void test_evaluate_when_input_is_null_returns_false()
    {
        ...
        // Act
        var result = new LengthIsGreaterThanOrEqualCondition { ComparerValue = comparer }.Evaluate(Context, inputValue);
    ...
    public void test_evaluate_when_input_is_invalid_type_throws()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<InvalidOperationException>(() => new LengthIsGreaterThanOrEqualCondition { ComparerValue = comparer }.Evaluate(Context, inputValue));
    }
