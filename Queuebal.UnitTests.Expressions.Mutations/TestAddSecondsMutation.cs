...
[TestClass]
public class TestAddSecondsMutation
{
    [TestMethod]
    public void test_evaluate_when_hours_is_int()
    {
        var mutation = new AddSecondsMutation
        {
            ...
            Seconds = new ValueExpression { Value = new JSONValue(5) }
        };
        ...
        // expected has the 5 seconds added
        var expected = DateTime.Parse("2023-10-01T12:00:05Z").ToUniversalTime();
    ...
    public void test_evaluate_when_hours_is_not_a_number()
    {
        var mutation = new AddSecondsMutation
        {
            Seconds = new ValueExpression { Value = new JSONValue("not a number") }
        };
