...
[TestClass]
public class TestAddYearsMutation
{
    [TestMethod]
    public void test_evaluate_when_hours_is_int()
    {
        var mutation = new AddYearsMutation
        {
            ...
            Years = new ValueExpression { Value = new JSONValue(5) }
        };
        ...
        // expected has the 5 years added
        var expected = DateTime.Parse("2028-10-01T12:00:00Z").ToUniversalTime();
    ...
    public void test_evaluate_when_hours_is_not_a_number()
    {
        var mutation = new AddYearsMutation
        {
            Years = new ValueExpression { Value = new JSONValue("not a number") }
        };
